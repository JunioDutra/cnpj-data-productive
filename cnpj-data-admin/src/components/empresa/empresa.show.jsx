import { DateField, FunctionField, ReferenceField, Show, SimpleShowLayout, TextField, useGetMany, useRecordContext } from 'react-admin';

const Estabelicimento = () => {
    const record = useRecordContext();
    const { data: estabelecimentos, isLoading, error } = useGetMany('estabelecimento', { id: record.cnpj_basico });
